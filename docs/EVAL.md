...
| T5  | "Find blue slip-on shoes in size 9 under $80 and add them to my cart, then start checkout." | Cart contains the variant and the checkout page was reached. |

## Metrics

- **success** — 1 if the criterion is met without human intervention; else 0.

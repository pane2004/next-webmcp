...
nextjs-webmcp exposes browser-side tools whose bodies are your server actions, executed in the user's own
...
Only the latest published `nextjs-webmcp` release receives fixes.

...
<p>Read the source in <code>examples/commerce/app/tools.ts</code> to see how tools are declared with Zod schemas and executed against the same server actions the UI uses.</p>`,
  },
  {

...
The nextjs-webmcp demo storefront, deployed at **https://next-webmcp-commerce.vercel.app**. A fork of
...
| footer (all routes)               | `subscribe_newsletter` (declarative `nextjs-webmcp/form`)                                        |
